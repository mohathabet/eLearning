...
class getCertificateRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CertificateRepository.php';

        return $container->privates['App\\Repository\\CertificateRepository'] = new \App\Repository\CertificateRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
