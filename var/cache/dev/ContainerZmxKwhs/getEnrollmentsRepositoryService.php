 ...
 */
class getEnrollmentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnrollmentsRepository' shared autowired service.
     *
     * @return \App\Repository\EnrollmentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnrollmentsRepository.php';

        return $container->privates['App\\Repository\\EnrollmentsRepository'] = new \App\Repository\EnrollmentsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
