...
class __TwigTemplate_2d31ad9942ca76158a934f9354ee097b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" method=\"post\">
            ...
            <input class=\"form-control mb-3\" type=\"text\" id=\"username\" name=\"_username\" value=\"";
        // line 12
        ...
        echo "\">
            ...
            <button class=\"btn btn-primary py-3 px-5 mt-2\" type=\"submit\">Login</button>
        </form>
    </div>
";
    ...
    {
        return array (  105 => 12,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container\">
        ...
        <form action=\"{{ path('app_login') }}\" method=\"post\">
            <label for=\"username\">Username:</label>
            <input class=\"form-control mb-3\" type=\"text\" id=\"username\" name=\"_username\" value=\"{{ last_username }}\">
            <label for=\"password\">Password:</label>
            <input class=\"form-control mb-3\" type=\"password\" id=\"password\" name=\"_password\">
            <input type=\"hidden\" name=\"_target_path\" value=\"/profile\">
            <button class=\"btn btn-primary py-3 px-5 mt-2\" type=\"submit\">Login</button>
...
{% endblock %}
", "login/index.html.twig", "C:\\Users\\hassen\\Desktop\\online-learning-platform-main (2)\\online-learning-platform-main\\online-learning-platform-main\\templates\\login\\index.html.twig");
    }
}
