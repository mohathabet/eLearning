...
class __TwigTemplate_e04dfb916cd94581206b99f90f8870b7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        ";
        // line 18
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 18, $this->source); })()), "roles", [], "any", false, false, false, 18), 'row', ["label" => "Registering As"]);
        // line 20
        echo "
        ";
        // line 21
        ...
        <button type=\"submit\" class=\"btn btn-primary py-3 px-5 mt-2\">Register</button>
        ";
        // line 24
...
";
    ...
    {
        return array (  140 => 24,  134 => 21,  131 => 20,  129 => 18,  126 => 17,  124 => 15,  120 => 14,  116 => 13,  112 => 12,  107 => 10,  104 => 9,  95 => 7,  91 => 6,  88 => 5,  78 => 4,  59 => 2,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "C:\\Users\\hassen\\Desktop\\online-learning-platform-main (2)\\online-learning-platform-main\\online-learning-platform-main\\templates\\registration\\register.html.twig");
    }
}
