 ...
 */
class getProgressRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProgressRepository' shared autowired service.
     *
     * @return \App\Repository\ProgressRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProgressRepository.php';

        return $container->privates['App\\Repository\\ProgressRepository'] = new \App\Repository\ProgressRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
