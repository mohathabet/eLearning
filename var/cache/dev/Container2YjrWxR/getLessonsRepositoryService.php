 ...
 */
class getLessonsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LessonsRepository' shared autowired service.
     *
     * @return \App\Repository\LessonsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LessonsRepository.php';

        return $container->privates['App\\Repository\\LessonsRepository'] = new \App\Repository\LessonsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
